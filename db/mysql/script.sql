...
--
-- Host: localhost:3306
-- Tempo de geração: 24/02/2022 às 18:43
...
--
-- Banco de dados: jgreenco_score
--

-- --------------------------------------------------------

--
-- Estrutura para tabela score_historico
--
CREATE DATABASE IF NOT EXISTS score;
USE score;
DROP TABLE IF EXISTS `score_historico`;
...
--
-- Despejando dados para a tabela score_historico
--
...
--
-- Índices de tabela score_historico
--
...
--
-- AUTO_INCREMENT de tabela score_historico
--
ALTER TABLE score_historico
